...
function Footer() {
  return (
    <section className=" bg-Very-Dark-Blue text-white">
      <div className="py-6 flex flex-col items-center gap-10 sm:flex-row max-w-5xl mx-auto px-6 sm:h-32">
        <div className="flex flex-col gap-16 items-center w-full logo sm:flex-row">
          <svg
            width="148"
            height="25"
          ...
          <ul className=" flex flex-col gap-6 text-lg text-center sm:flex-row">
