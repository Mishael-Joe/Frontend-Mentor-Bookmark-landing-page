    ...
    <nav className="w-full md:max-w-6xl mx-auto py-4 px-6 z-40 flex justify-between sm:items-center relative">
      ...
      <div className="w-1/2 lg:w-1/3 hidden md:inline-block">
        <ul className="flex flex-row gap-1 justify-between items-center">
          <li className="font-semibold cursor-pointer transition-all delay-100 hover:border-white hover:text-Soft-Red">
            Features
          </li>
          <li className="font-semibold cursor-pointer transition-all delay-100 hover:border-white hover:text-Soft-Red">
            Pricing
          ...
          <li className="font-semibold cursor-pointer">
            <button className=" border rounded p-2 px-4 w-full transition-all delay-100 hover:text-Soft-Red hover:border-Soft-Red">
              Login
            </button>
          </li>
        </ul>
        ...
        <div className="absolute inset-0 b-Very-Dark-Blue/90 text-white flex flex-col gap-16 items-center">
          <div className="p-6 w-full bg-Very-Dark-Blue/90 min-h-screen">
            ...
            <ul className="flex flex-col text-white gap-1 mt-4 items-center">
              <li className=" border-t w-full flex py-6 text-xl font-semibold cursor-pointer justify-center transition-all delay-100 hover:border-white hover:text-Soft-Red">
                Features
              </li>
              <li className=" border-t w-full flex py-6 text-xl font-semibold cursor-pointer justify-center transition-all delay-100 hover:border-white hover:text-Soft-Red">
                Pricing
              ...
              <li className=" border-t w-full flex py-6 text-xl font-semibold cursor-pointer justify-center">
                <button className=" border rounded p-4 w-full transition-all delay-100 hover:text-Soft-Red">
                  Login
                </button>
              </li>
            </ul>
          ...
          <div className="flex gap-6 items-center social-media">
